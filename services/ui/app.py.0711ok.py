...
def render_credit_header():
    ...
    # stage badges (same look & readability in dark/light)
    st.markdown("""
    <div style="display:flex;gap:.6rem;flex-wrap:wrap;margin:.35rem 0 1rem 0;">
      ...
      <span style="padding:.28rem .6rem;border-radius:.6rem;background:#d97706;color:#fff;font-weight:600;">C) Credit Appraisal by AI</span>
      <span style="padding:.28rem .6rem;border-radius:.6rem;background:#7c3aed;color:#fff;font-weight:600;">D) Human Review & Feedback</span>
      <span style="padding:.28rem .6rem;border-radius:.6rem;background:#a16207;color:#fff;font-weight:600;">E) Training (Feedback → Retrain)</span>
      <span style="padding:.28rem .6rem;border-radius:.6rem;background:#e11d48;color:#fff;font-weight:600;">F) Deployment of Credit Model</span>
      <span style="padding:.28rem .6rem;border-radius:.6rem;background:#0ea5e9;color:#fff;font-weight:600;">G) Monitoring & Drift</span>
      <span style="padding:.28rem .6rem;border-radius:.6rem;background:#64748b;color:#fff;font-weight:600;">H) Reporting & Handoff</span>
    </div>
    """, unsafe_allow_html=True)
...
if stage == "credit_agent":
    # (optional) keep your global nav above headers if you have one
    # render_nav_bar_app()
